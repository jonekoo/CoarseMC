...
REAL(SP) ::rf_s 
REAL(SP), PARAMETER :: ERRTOL=0.0025_sp,TINY=1.5e-38_sp,BIG=3.0e37_sp,& 
  THIRD=1.0_sp/3.0_sp,&
  ...
  !! x, y, andz must be nonnegative, and at most one can be zero. TINY must be   !! at least 5 times the machine underflow limit, BIG at most one-fifth the
