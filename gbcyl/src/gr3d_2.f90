...
!!
subroutine gr3d_2(particles, N, mask_i, mask_j, Lx, Ly, Lz, x_periodic, y_periodic, z_periodic,& 
  ...
  logical, intent(in) :: mask_i(N), mask_j(N)
  ...
  density = real(count(mask_j),dp)/(Lx*Ly*Lz) 
