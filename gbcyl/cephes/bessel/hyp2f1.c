...
nosum:
	...
	//printf("a, b, c, x, d2, y, p = %f, %f, %f, %f, %f %f %f\n", a, b, c, x, d2, y, p);
	//printf("a, d2, gamma(a+d2) = %f, %f, %f", a, d2, gamma(a + d2));
	y *= p / (gamma(a+d2) * gamma(b+d2));  // If a is a negative integer, b = a + 1, c = 1 this can produce nan
